...
def parse_args():
    ...
    parser.add_argument('--loss-type',dest='loss_type', type=int, default=4, help='loss type')
    parser.add_argument('--verbose', type=int, default=1, help='do verification testing and model saving every verbose batches')
    parser.add_argument('--max-steps',dest='max_steps', type=int, default=0, help='max training batches')
    parser.add_argument('--end-epoch',dest='end_epoch', type=int, default=100000, help='training epoch size.')
    parser.add_argument('--network', default='r50', help='specify network')
    parser.add_argument('--version-se',dest='version_se', type=int, default=0, help='whether to use se in network')
    parser.add_argument('--version-input',dest='version_input', type=int, default=1, help='network input config')
    parser.add_argument('--version-output',dest='version_output', type=str, default='E', help='network embedding output config')
    parser.add_argument('--version-unit',dest='version_unit', type=int, default=3, help='resnet unit config')
    parser.add_argument('--version-act',dest='version_act', type=str, default='prelu', help='network activation config')
    parser.add_argument('--use-deformable',dest='use_deformable', type=int, default=0, help='use deformable cnn in network')
    parser.add_argument('--lr', type=float, default=0.01, help='start learning rate')
    parser.add_argument('--lr-steps',dest='lr_steps', type=str, default='', help='steps of lr changing')
    parser.add_argument('--wd', type=float, default=0.0005, help='weight decay')
    parser.add_argument('--fc7-wd-mult',dest='fc7_wd_mult', type=float, default=1.0, help='weight decay mult for fc7')
    parser.add_argument('--bn-mom',dest='bn_norm', type=float, default=0.9, help='bn mom')
    ...
    parser.add_argument('--beta-min',dest='beta_min', type=float, default=5., help='param for sphere')
    parser.add_argument('--beta-freeze',dest='beta_freeze', type=int, default=0, help='param for sphere')
    ...
    parser.add_argument('--rand-mirror',dest='rand_mirror', type=int, default=1, help='if do random mirror in training')
...
def train_net(args):
    ...
    metric1 = mx.metric.create(_metric)
    metric2 = mx.metric.create(LossValueMetric())
    ...
    for name in args.target.split(','):
        ...
        if os.path.exists(path):
            if config.val_mirror:
                data_set = verification.load_bin_(path, image_size)
            else:
